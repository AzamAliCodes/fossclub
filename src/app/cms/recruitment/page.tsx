...
export default function CMSRecruitmentRoutePage() {
  ...
  return (
    <div className="pt-28 pb-16 relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-white/10">
        ...
        <span className="text-xs font-mono text-emerald-400">Recruitment Manager Subroute</span>
      </div>
      <CMSRecruitmentManager />
    </div>
  );
}
